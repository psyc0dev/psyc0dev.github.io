...
const WORD_SYNCED_LYRICS = [
  ...
  { time: 3.65, text: "brraaa", isAdlib: false },
  ...
  { time: 10.27, text: "what you do", isAdlib: false },
  { time: 10.97, text: "when you're gone?", isAdlib: false },
  { time: 12.17, text: "nothin' wrong", isAdlib: false },
  { time: 12.97, text: "bein' private", isAdlib: false },
  ...
  { time: 22.07, text: "what side", isAdlib: false },
  ...
  { time: 153.17, text: "in life, that's cold", isAdlib: false },
  { time: 155.77, text: "you can't ignore,", isAdlib: false },
  { time: 157.02, text: "you're spending your life", isAdlib: false },
  ...
  { time: 165.02, text: "unless everything rights", isAdlib: false },
  ...
  { time: 186.12, text: "who will Gru be", isAdlib: false },
  { time: 187.32, text: "tonight?", isAdlib: false },
...
class ThreeKineticEngine {
  ...
  getVisibleBounds(depthZ = 0) {
    const distance = this.camera.position.z - depthZ;
  ...
  startLoop() {
    const tick = () => {
      ...
      for (let i = this.activeParticles.length - 1; i >= 0; i--) {
        ...
        const finalScale = scale * (p.scaleMultiplier || 1.0);
